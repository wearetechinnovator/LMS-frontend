            ...
            <div className="grid grid-cols-12 gap-3 py-1 items-start">
              ...
              <div className="col-span-8 space-y-1.5">
                <div
                  ...
                  className={`w-full min-h-[75px] border border-dashed rounded flex flex-col items-center justify-center p-3 transition-all cursor-pointer bg-[#f7fafc] ${dragActive ? 'border-sky-500 bg-sky-50/20' : 'border-slate-355 hover:border-sky-500'
                    }`}
                >
                  <input
                    type="file"
                            ...
                            {filteredLeads.slice(0, 5).map((lead) => (
                              <tr key={lead.id} className="hover:bg-slate-50 text-slate-700 font-medium">
                                ...
                                <td className="py-1.5 px-2">
                                  <span className={`px-1 rounded text-[9px] font-bold ${lead.status === 'NEW' ? 'bg-teal-50 text-teal-700 border border-teal-200' :
              ...
              <div className="space-y-3 border-t border-slate-100 pt-3">
                ...
                <div className="grid grid-cols-12 gap-3 py-1 items-center">
                  ...
                  <div className="col-span-8 flex flex-wrap gap-2">
                    <span className={`px-2 py-0.5 rounded text-[10.5px] font-bold border ${parsedManualRecipients.emails.length > 0 ? 'bg-green-50 text-green-700 border-green-200' : 'bg-slate-50 text-slate-400 border-slate-200'
                      }`}>
                      {parsedManualRecipients.emails.length} Valid Emails
                    </span>
                    <span className={`px-2 py-0.5 rounded text-[10.5px] font-bold border ${parsedManualRecipients.phones.length > 0 ? 'bg-green-50 text-green-700 border-green-200' : 'bg-slate-50 text-slate-400 border-slate-200'
                      }`}>
